...
rospy.Subscriber('/zumo/prox_left', Int8, handle_zumo_sensor_right)			#left object turn right
rospy.Subscriber('/zumo/prox_right', Int8, handle_zumo_sensor_left)			#right object turn left
